...
void print_row (int n_values, char** values);
	...
	const char* creatTableSql = "create table tblTest(id int, name QString)";
	const char* deleteTableSql = "create table tblTest(id int, name QString)";
	const char* insertTableSql = "create table tblTest(id int, name QString)";
	const char* creatTableSql = "create table tblTest(id int, name QString)";
	int rc = 0;
	bool createTable ()
	{
