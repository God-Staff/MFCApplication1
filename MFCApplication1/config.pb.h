...
namespace qiuwanli {
	...
	const Config_Type Config_Type_Type_MIN = Config_Type_FilePath;
	const Config_Type Config_Type_Type_MAX = Config_Type_DownFilePath;
	...
	public:
		...
		static const Type UPSIZE =
			Config_Type_UPSIZE;
		static const Type DOWNSIZE =
			Config_Type_DOWNSIZE;
